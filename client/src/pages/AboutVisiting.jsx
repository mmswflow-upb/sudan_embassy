...
export default function AboutVisiting(){
  ...
  return (
    <main className="container mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold text-sudan-black mb-6">{t('about.visiting_title')}</h1>
      <div className="bg-white rounded-lg shadow-sm p-6 space-y-4 leading-relaxed text-gray-700">
        <h2 className="text-xl font-semibold">Sudan in the international arena</h2>
        ...
        <h2 className="text-xl font-semibold">Bilateral relations</h2>
        ...
        <h2 className="text-xl font-semibold">Challenges and diplomacy</h2>
